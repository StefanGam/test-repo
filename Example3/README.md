...
<img src="https://github.com/StefanGam/test-repo/blob/main/quantlet_design.png?raw=true" alt="Header Image" width="100%" style="display: block; margin: 0 0 0px 0; padding: 0; border: none;" />
</a>
</div>

<div style="text-align: center; margin-top: 0px;">
<img src="https://github.com/StefanGam/test-repo/blob/main/Quantlet_readme.png?raw=true" alt="Additional Logo" width="10%" style="margin-top: 0px;" />
</div>
