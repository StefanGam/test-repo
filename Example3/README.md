...
<img src="https://github.com/StefanGam/test-repo/blob/main/Quantlet_readme.jpeg?raw=true" alt="Additional Logo" width="50%" style="margin-top: 20px;" />
</div>

<div style="text-align: center; margin-top: 10px;">
<img src="https://github.com/StefanGam/test-repo/blob/main/Quantlet_readme.jpeg?raw=true" alt="Additional Logo" width="5%" style="margin-top: 0px;" />
</div>
