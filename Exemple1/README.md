...
<img src="https://github.com/StefanGam/test-repo/blob/main/quantlet_design.png?raw=true" alt="Header Image" width="100%" style="display: block; margin: 0 0 10px 0; padding: 0; border: none;" />
</div>
